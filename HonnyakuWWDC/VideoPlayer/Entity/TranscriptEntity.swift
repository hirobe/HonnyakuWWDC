...
struct TranscriptEntity: Hashable, Codable {
    ...
    static var mock: TranscriptEntity = {
        let p0 = Paragraph(at: 0, sentences: [(Int, String)]([
        ...
        let p1 = Paragraph(at: 5, sentences: [(Int, String)]([
            (5, "a"), (6, "b"), (7, "c"), (8, "d"), (9, "e"),
            (10, "あ"), (11, "い"), (12, "う"), (13, "え"), (14, "お"),
            (25, "a"), (26, "b"), (27, "c"), (28, "d"), (29, "e"),
            (30, "あ"), (31, "い"), (32, "う"), (33, "え"), (34, "お"),
            (45, "a"), (46, "b"), (47, "c"), (48, "d"), (49, "e"),
            (50, "あ"), (51, "い"), (52, "う"), (53, "え"), (54, "お")
        ]).map { at, text in Paragraph.Sentence(at: at, text: text) })

        return TranscriptEntity(language: "JA", paragraphs: [p0, p1])
    }()
}
